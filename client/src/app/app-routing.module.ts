...
const routes: Routes = [
  ...
  {path: 'project/project-list/add', component: ProjectDetailsComponent, data: {title: 'Add Project'}},
  {path: 'project/project-list/edit/:id', component: ProjectDetailsComponent, data: {title: 'Edit Project'}},
  {path: 'project/project-list/delete/:id', component: ProjectDeleteComponent, data: {title: 'Add Project'}},
